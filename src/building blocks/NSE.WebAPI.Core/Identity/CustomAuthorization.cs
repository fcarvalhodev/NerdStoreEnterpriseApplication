...
namespace NSE.WebAPI.Core.Identity
{
    ...
    {
        public static bool CheckItClaimsUser(HttpContext context, string claimName, string claimValue)
        {
    ...
    public class RequirementClaimFilter : IAuthorizationFilter
    {
        ...
        public void OnAuthorization(AuthorizationFilterContext context)
        {
            ...
            if (!CustomAuthorization.CheckItClaimsUser(context.HttpContext, _claim.Type, _claim.Value))
            {
